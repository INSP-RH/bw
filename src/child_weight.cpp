...
void Child::getParameters(void){
    ...
    req[1][nind]    = 948*(1-sex)+865.0*sex;
    req[2][nind]    =1129.0*(1 - sex) + 1047.0*sex;

    /*req[1]    =948.0*(1 - sex) + 865.0*sex;
    req[2]    =1129.0*(1 - sex) + 1047.0*sex;
    req[3]    =1252.0*(1 - sex) + 1156.0*sex;
    req[4]    =1360.0*(1 - sex) + 1241.0*sex;
    req[5]    =1467.0*(1 - sex) + 1330.0*sex;
    req[6]    =1573.0*(1 - sex) + 1428.0*sex;
    req[7]    =1692.0*(1 - sex) + 1554.0*sex;
    req[8]    =1830.0*(1 - sex) + 1698.0*sex;
    req[9]    =1978.0*(1 - sex) + 1854.0*sex;
    req[10]   =2150.0*(1 - sex) + 2006.0*sex;
    req[11]   =2341.0*(1 - sex) + 2149.0*sex;
    req[12]   =2548.0*(1 - sex) + 2276.0*sex;
    req[13]   =2770.0*(1 - sex) + 2379.0*sex;
    req[14]   =2990.0*(1 - sex) + 2249.0*sex;
    req[15]   =3178.0*(1 - sex) + 2491.0*sex;
    req[16]   =3322.0*(1 - sex) + 2503.0*sex;
    req[17]   =3410.0*(1 - sex) + 2503.0*sex;*/
}
