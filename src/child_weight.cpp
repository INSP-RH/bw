...
void Child::getParameters(void){
    ...
    req[1]    =948*(1 - sex) + 865*sex;
    req[2]    =1129*(1 - sex) + 1047*sex;
    req[3]    =1252*(1 - sex) + 1156*sex;
    req[4]    =1360*(1 - sex) + 1241*sex;
    req[5]    =1467*(1 - sex) + 1330*sex;
    req[6]    =1573*(1 - sex) + 1428*sex;
    req[7]    =1692*(1 - sex) + 1554*sex;
    req[8]    =1830*(1 - sex) + 1698*sex;
    req[9]    =1978*(1 - sex) + 1854*sex;
    req[10]   =2150*(1 - sex) + 2006*sex;
    req[11]   =2341*(1 - sex) + 2149*sex;
    req[12]   =2548*(1 - sex) + 2276*sex;
    req[13]   =2770*(1 - sex) + 2379*sex;
    req[14]   =2990*(1 - sex) + 2249*sex;
    req[15]   =3178*(1 - sex) + 2491*sex;
    req[16]   =3322*(1 - sex) + 2503*sex;
    req[17]   =3410*(1 - sex) + 2503*sex;
}
