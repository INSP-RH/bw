...
void Child::getParameters(void){
    ...
    K         = 800*(1 - sex)*365 + 700*sex*365;
    deltamax  = 19*(1 - sex)*365 + 17*sex*365;
    A         = 3.2*(1 - sex)*365 + 2.3*sex*365;
    B         = 9.6*(1 - sex)*365 + 8.4*sex*365;
    D         = 10.1*(1 - sex)*365 + 1.1*sex*365;
    ...
    A_EB      = 7.2*(1 - sex)*365 + 16.5*sex*365;
    B_EB      = 30*(1 - sex)*365 + 47.0*sex*365;
    D_EB      = 21*(1 - sex)*365 + 41.0*sex*365;
    ...
    A1        = 3.2*(1 - sex)*365 + 2.3*sex*365;
    B1        = 9.6*(1 - sex)*365 + 8.4*sex*365;
    D1        = 10.0*(1 - sex)*365 + 1.1*sex*365;
